...
@interface ProductClauseController ()<WKNavigationDelegate>
/*
 *  WKWebView
 */
...
@implementation ProductClauseController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.view.backgroundColor = LYColor_A7;
    [self setProductClauseTopView];
...
-(void)setProductClauseTopView
{
    ...
    [backBtn addTarget:self action:@selector(productClausebackClick) forControlEvents:UIControlEventTouchDown];
    [topView addSubview:backBtn];
    
}
-(void)productClausebackClick{
