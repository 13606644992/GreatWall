...
#import "YiChuDanGeXianVC.h"
#import "YiZhongZhiGeXianVC.h"
@interface GeXianViewController ()
...
@property (nonatomic, strong)QuanBuGeXianVC *quanbuVC;
@property (nonatomic, strong)DaiChuDanGeXianVC *daichudanVC;
@property (nonatomic, strong)YiChuDanGeXianVC *yichudanVC;
@property (nonatomic, strong)YiZhongZhiGeXianVC *yizhongzhiVC;
@end

@implementation GeXianViewController
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"个险保单";
    ...
    //添加子试图控制器
    self.quanbuVC = [[QuanBuGeXianVC alloc]init];
    ...
    self.daichudanVC = [[DaiChuDanGeXianVC alloc]init];
    ...
    self.yichudanVC = [[YiChuDanGeXianVC alloc]init];
    ...
    self.yizhongzhiVC = [[YiZhongZhiGeXianVC alloc]init];
