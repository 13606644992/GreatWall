...
#pragma mark - 数据请求
- (void)getData{
    NSMutableDictionary *paramers = [NSMutableDictionary dictionaryWithDictionary:@{@"userId" : [[NSUserDefaults standardUserDefaults] objectForKey:@"GJ_userId"], @"policySts" : @"0",@"classType":@"2", @"pageSize" : @"3", @"pageIndex" : [NSString stringWithFormat:@"%ld", (long)self.page]}];
    NSLog(@"%@", paramers);
...
//        return 480;
//    }
    NSLog(@"个保列表cell高度=========%f",[heights[@(indexPath.row)] floatValue]);
