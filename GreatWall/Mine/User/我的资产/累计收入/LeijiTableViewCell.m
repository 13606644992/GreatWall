...
- (void)setLeiJiModel:(LeiJiShouRuModel *)leiJiModel{
    _leiJiModel = leiJiModel;
//    NSString *year = [leiJiModel.tradeTime substringWithRange:NSMakeRange(0, 4)];
//    NSString *month = [leiJiModel.tradeTime substringWithRange:NSMakeRange(5, 2)];
//    self.date.text = [NSString stringWithFormat:@"%@年%@月",year,month];
    self.date.text = leiJiModel.tradeTime;
    self.money.text = leiJiModel.monthTotalAmount;
}
