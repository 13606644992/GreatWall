...
@interface ProductInfoController ()<WKNavigationDelegate>
/*
 *  WKWebView
 */
...
-(void)setProductInfoTopView
{
    ...
    [backBtn addTarget:self action:@selector(productInfobackClick) forControlEvents:UIControlEventTouchDown];
    [topView addSubview:backBtn];
    
}
-(void)productInfobackClick{
