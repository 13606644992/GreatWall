...
- (void)updateBadgeFrame
{
    ...
    self.badge.frame = CGRectMake(self.badgeOriginX, self.badgeOriginY, minWidth + padding-4, minHeight + padding-4);
    self.badge.layer.cornerRadius = (minHeight + padding-4) / 2;
