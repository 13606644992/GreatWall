...
@interface ProductDetailController ()<WKNavigationDelegate>
/*
 *  WKWebView
 */
...
-(void)setProductDetailTopView
{
    ...
    [backBtn addTarget:self action:@selector(productdetailbackClick) forControlEvents:UIControlEventTouchDown];
    [topView addSubview:backBtn];
    
}
-(void)productdetailbackClick{
